...
var x__31240__auto__ = (((x == null))?null:x);
var m__31241__auto__ = (sablono.util.to_str[goog.typeOf(x__31240__auto__)]);
if(!((m__31241__auto__ == null))){
return m__31241__auto__.call(null,x);
} else {
var m__31241__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__31241__auto____$1 == null))){
return m__31241__auto____$1.call(null,x);
} else {
...
var x__31240__auto__ = (((x == null))?null:x);
var m__31241__auto__ = (sablono.util.to_uri[goog.typeOf(x__31240__auto__)]);
if(!((m__31241__auto__ == null))){
return m__31241__auto__.call(null,x);
} else {
var m__31241__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__31241__auto____$1 == null))){
return m__31241__auto____$1.call(null,x);
} else {
...
var len__31652__auto___32700 = arguments.length;
var i__31653__auto___32701 = (0);
while(true){
if((i__31653__auto___32701 < len__31652__auto___32700)){
args__31659__auto__.push((arguments[i__31653__auto___32701]));

var G__32702 = (i__31653__auto___32701 + (1));
i__31653__auto___32701 = G__32702;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__31660__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq32699){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32699));
});
...
var vec__32706 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__32708;
var words = seq__32707__$1;
...
var G__32710 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__32710,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__32710;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__32711_SHARP_){
if(typeof p1__32711_SHARP_ === 'string'){
return p1__32711_SHARP_;
} else {
return cljs.core.seq.call(null,p1__32711_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__30577__auto__ = x__$1.hasDomain();
